...
namespace SomeDataBaseEditor.GUI_DataTables.Catalogs
{
    public partial class ProfiliPodgotovki : Form
    {
        ...
        {
            string query = "SELECT        [Профили подготовки].Код, [Профили подготовки].Имя, [Направления подготовки].Имя AS Направление, [Направления подготовки].Код AS [Код Направления] "
            ...
            dataGridView1.DataSource = helpers.GetDataTable(query);
